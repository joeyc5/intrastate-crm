import { loadRates, packingContainers, bulkyArticles } from "../lib/pricing";
...
export default function HomePage() {
  ...
  const containers = packingContainers(rates);
  const bulky = bulkyArticles(rates);
  return (
    <div className="mx-auto max-w-3xl px-6 py-10">
      ...
      <QuoteForm counties={counties} packingContainers={containers} bulkyArticles={bulky} />
    </div>
  );
}
